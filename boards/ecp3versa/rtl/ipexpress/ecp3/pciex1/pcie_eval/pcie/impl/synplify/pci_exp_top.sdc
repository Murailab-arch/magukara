...
# C:\shared\PROJECTS\PCI_EXP_X1_11\PCI_EXP_X1_11\technology\ver1.0\syn\exp2m\config1\synplicity\top\verilog\pci_exp_x1_top.sdc
# Written on Tue May 09 10:56:02 2006
# by Synplify for Lattice, Synplify for Lattice 8.5D Scope Editor

#
# Clocks
#
define_clock -disable   -name {CLK_I}  -freq 50.000 -clockgroup default_clkgroup_0
define_clock -disable   -name {sys_clk_125}  -freq 200.000 -clockgroup default_clkgroup_1
define_clock -disable   -name {sys_clk_250}  -freq 350.000 -clockgroup default_clkgroup_2
